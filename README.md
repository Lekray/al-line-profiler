...
| `docs/` | [RUNBOOK.md](docs/RUNBOOK.md) — пошаговый прогон стенда; [audit-2026-08-14.md](docs/audit-2026-08-14.md) — аудит инструментария: 63 находки, 34 подтверждены чтением кода и живым воспроизведением |
