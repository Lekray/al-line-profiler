...
у объекта не отработала ни одна точка входа: под ним иначе не осталось бы ничего.
...
```
6636849a0fac7e6bb3822d7822ee8490817133bb946af9fd6da04b49f1995871 *LineProfiler.fob
```
...
Работает и обкатан на стенде **NAV 2018**: встроенная обкатка даёт **55 из 55**,
...
Пятая — встроенная обкатка (**55 из 55**) — запускается в самой базе NAV: то, что
