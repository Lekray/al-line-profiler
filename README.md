...
```
fbb9e17cf305c3e5c99076cf10891c72bd1a62017f6e3b928ac54555592c4e71 *LineProfiler.fob
```
...
Работает и обкатан на стенде **NAV 2018**: встроенная обкатка даёт **54 из 54**,
...
Пятая — встроенная обкатка (**54 из 54**) — запускается в самой базе NAV: то, что
