...
```
8bc8111f4ff7ee10cc4afe9f6899351e40555f3b62a181f226f139dc0e6feaa1 *LineProfiler.fob
```
...
Работает и обкатан на стенде **NAV 2018**: встроенная обкатка даёт **45 из 45**,
...
Пятая — встроенная обкатка (**45 из 45**) — запускается в самой базе NAV: то, что
