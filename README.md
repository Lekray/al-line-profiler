...
```
1e78b9fc77ec815d2de834468fed84cfee31de6aa93ed9df3d31bfedc3135725 *LineProfiler.fob
```
...
Работает и обкатан на стенде **NAV 2018**: встроенная обкатка даёт **34 из 34**,
...
Пятая — встроенная обкатка (**34 из 34**) — запускается в самой базе NAV: то, что
