...
```
fd83123ce636c9a5f07c3f2b532bbb7407ef10a782f6d4e23174efb7608b82dd *LineProfiler.fob
```
...
Работает и обкатан на стенде **NAV 2018**: встроенная обкатка даёт **48 из 48**,
...
Пятая — встроенная обкатка (**48 из 48**) — запускается в самой базе NAV: то, что
