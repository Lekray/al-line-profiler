...
```
2a49b16591bdea26702bf8c25ba6c0d5bd926675384016219c8d959a1c0ffb72 *LineProfiler.fob
```
...
Работает и обкатан на стенде **NAV 2018**: встроенная обкатка даёт **40 из 40**,
...
Пятая — встроенная обкатка (**40 из 40**) — запускается в самой базе NAV: то, что
