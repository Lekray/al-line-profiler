...
```
b7ab822ffe745d85bc208b975310714fd11ec1eca0b1492ecff80ec9a323b593 *LineProfiler.fob
```
...
Работает и обкатан на стенде **NAV 2018**: встроенная обкатка даёт **43 из 43**,
...
Пятая — встроенная обкатка (**43 из 43**) — запускается в самой базе NAV: то, что
