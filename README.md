...
```
1d3d70f93676b2e85ec538a56ec136584f69ac7c0070dc8e6831474ca3dec8ae *LineProfiler.fob
```
...
Работает и обкатан на стенде **NAV 2018**: встроенная обкатка даёт **41 из 41**,
...
Пятая — встроенная обкатка (**41 из 41**) — запускается в самой базе NAV: то, что
